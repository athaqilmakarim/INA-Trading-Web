...
const features = [
  {
    title: "Global Reach",
    description: "Akses ke pasar internasional untuk UKM, Koperasi & Industri Indonesia",
    icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
  },
  {
    title: "Digital Integration",
    description: "Platform terintegrasi untuk ekspor, promosi, dan penjualan",
    icon: "M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"
  },
  {
    title: "Secure Transactions",
    description: "Transaksi aman dengan teknologi blockchain dan digital security",
...
const sections = [
  ...
  },
  {
    ...
    content: [
      {
        text: "UKM, KOPERASI & INDUSTRI",
        icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"
      },
      {
        text: "Aggregator di dalam & luar negeri",
        icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"
      },
      {
        text: "Ekportir & Importir",
        icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"
      },
      {
        text: "Masyarakat, pemilik usaha di luar negeri",
        icon: "M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"
      }
    ],
    footer: "Dikelola oleh PERURI & Indonesia In Your Hand",
  ...
  },
  {
    ...
    content: [
      {
        text: "Fitur searching lokasi restoraunt, cafe, toko yang menjual produk Indonesia di kota dan negara tertentu.",
        icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"
      },
      {
        text: "Fitur pembelian produk Indonesia yang ada di UKM BOX Fulfillment Center di Australia & Eropa",
        icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"
      },
      {
        text: "Fitur pemesanan produk / pemesanan tempat di sebuah restaurant / cafe di kota dan negara tertentu.",
...
const About = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-blue-900 to-black py-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Platform B2B & B2C untuk UKM, Koperasi & Industri Indonesia menuju pasar global
            </p>
          </motion.div>
        </div>
      </div>
