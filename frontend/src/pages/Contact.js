            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-gray-700">WhatsApp: <a href="https://wa.me/628118119044" className="text-red-600 hover:underline">+62 811 8119 044</a></p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-3">
                    <p className="text-gray-700">Email: <a href="mailto:admin@inatrading.co.id" className="text-red-600 hover:underline">admin@inatrading.co.id</a></p>
                  </div>
                </div>
              </div>
            </div>
